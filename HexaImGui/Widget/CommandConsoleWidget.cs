...
public class CommandConsoleWidget : BaseWidget
{
    ...
    public CommandConsoleWidget(string widgetName, string ownerWindowName)
    ...
    public override void OnRender(DateTime utcNow, double deltaSec)
    {
        ...
        string consoleInputLabel = $"##{WidgetName}#ConsoleInput";
